...
$result = mysql_query("SELECT e.*, el.SubmissionDate, eld.* FROM
          ...
          WHERE eld.Response != 1");


while($row = mysql_fetch_array($result))
{
    echo "<tr>";
    echo"<th><a href='leaveform.php?EmployeeLeaveId=" . $row['EmployeeLeaveId'] .  "'>Detail</a></th>";
